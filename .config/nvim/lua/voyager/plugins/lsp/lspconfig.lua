    ...
    config = function()
        ...
        vim.api.nvim_create_autocmd("LspAttach", {
            ...
            callback = function(ev)
                ...
                keymap.set({ "n", "v" }, "<leader>vc", vim.lsp.buf.code_action, opts) -- see available code actions, in visual mode will apply to selection
                ...
                keymap.set("n", "<leader>vws", vim.lsp.buf.workspace_symbol, opts) -- mapping to restart lsp if necessary

                opts.desc = "Signature help"
                keymap.set("i", "<C-h>", vim.lsp.buf.signature_help, opts) -- mapping to restart lsp if necessary

                opts.desc = "Goto Header (Clangd)"
